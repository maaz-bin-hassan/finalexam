      ...
      <div className="widget">
        ...
        <div className="features" style={featuresStyle}>
          ...
          <div className="feature-2" style={feature2Style}>
            ...
            />
            <div className="total-sales" style={totalSalesStyle}>
              Total Sales
            </div>
          </div>
        ...
        <div
          className="elements-placeholder-radiu"
          style={elementsPlaceholderRadiuStyle}
        >
          <div className="base" />
        </div>
        <img
          className="elements-buttons-icon-32"
          alt=""
          src={elementsButtonsIcon32px}
          style={elementsButtonsIcon32Style}
        />
        <div className="check-out-each" style={checkOutEachStyle}>
