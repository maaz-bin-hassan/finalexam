...
import "./ElementsWidgetsWidget03.css";
...
const ElementsWidgetsWidget03 = ({
  ...
  return (
    <div
      className="elements-widgets-widget-03"
      style={elementsWidgetsWidget03Style}
    >
      <div className="widget1">
        <div className="base4" style={base2Style} />
        ...
        />
        <div className="create-screens-direc" style={createScreensDirecStyle}>
        ...
        >
          {baseVisible && <div className="base4" />}
        </div>
        <img
          className="icons-bookmark1"
          alt=""
          src={iconsBookmark}
          style={iconsBookmarkStyle}
        />
        <div className="daily-news" style={dailyNewsStyle}>
          Daily News
        </div>
      </div>
    </div>
